...
public class TypicalFlashcards {
    ...
    public static final Flashcard CARL =
            new FlashcardBuilder().withTitle("Carl Kurz").withAddress("wall street").build();
    public static final Flashcard DANIEL =
            new FlashcardBuilder().withTitle("Daniel Meier").withAddress("10th street").withTags("friends").build();
    public static final Flashcard ELLE = new FlashcardBuilder().withTitle("Elle Meyer")
            .withAddress("michegan ave").build();
    public static final Flashcard FIONA =
            new FlashcardBuilder().withTitle("Fiona Kunz").withAddress("little tokyo").build();
    public static final Flashcard GEORGE =
            new FlashcardBuilder().withTitle("George Best").withAddress("4th street").build();

    // Manually added
    public static final Flashcard HOON =
            new FlashcardBuilder().withTitle("Hoon Meier").withAddress("little india").build();
    public static final Flashcard IDA =
            new FlashcardBuilder().withTitle("Ida Mueller").withAddress("chicago ave").build();
