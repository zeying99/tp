...
public class ParserUtilTest {
    ...
    private static final String VALID_DEFINITION = "<VALID_DEFINITION> placeholder";
    ...
    public void parseDefinition_validValueWithoutWhitespace_returnsDefinition() throws Exception {
        Definition expectedDefinition = new Definition(VALID_DEFINITION);
        assertEquals(expectedDefinition, ParserUtil.parseDefinition(VALID_DEFINITION));
    }

    @Test
    public void parseDefinition_validValueWithWhitespace_returnsTrimmedDefinition() throws Exception {
        String addressWithWhitespace = WHITESPACE + VALID_DEFINITION + WHITESPACE;
        Definition expectedDefinition = new Definition(VALID_DEFINITION);
        assertEquals(expectedDefinition, ParserUtil.parseDefinition(addressWithWhitespace));
    }
