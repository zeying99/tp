...
import seedu.address.model.QuestionComparator;
 ...
 * As such, adding and updating of persons uses Question#isSameQuestion(Question) for equality so as to ensure
 * that the question being added or updated is unique in terms of identity in the UniquePersonList. However, the
 * removal of a question uses Question#equals(Object) so as to ensure that the question with exactly the same
...
public class UniqueQuestionList implements Iterable<Question> {
     ...
     */
    public void sortQuestions(String sortOrder) {
        QuestionComparator flashcardComparator = new QuestionComparator();
